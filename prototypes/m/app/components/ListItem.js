...
let ListItem = React.createClass({
  ...
  render: function() {
    ...
    let letterClassnames = classNames({
      ...
      'letter_faved': letter.faved
    });

    return (
      <div className={letterClassnames}>
        <div className="letter__checkbox" onClick={this._onToggleChecked}>
        ...
        <div className="letter__star" onClick={this._onToggleFaved}>
        ...
        <div className="letter__sender">{letter.sender}</div>
        <div className="letter__subject">{letter.subject}</div>
        <div className="letter__snippet">{letter.snippet}</div>
