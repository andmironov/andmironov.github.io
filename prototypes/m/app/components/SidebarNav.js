...
let SidebarNav = React.createClass({
    ...
    return {
      ...
      folders : [
        ...
        },
        {
          name: "drafts",
          title: "Черновики",
          link: "mail/filter/folder/drafts",
  ...
  render: function() {
    let folders = this.state.folders.map((folder, i) => {
      ...
      return <SidebarItem key={i} link={folder.link} title={folder.title} counter={this.props.newLettersCount[folder.name]} icon={folder.icon} isHidden={IsNavItemHidden}/>
    })
